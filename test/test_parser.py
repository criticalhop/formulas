...
class TestParser(unittest.TestCase):
    @ddt.data(
        ...
        ("=VLOOKUP('[file name.xlsx]sheet1'!MINITABLE[[#THIS ROW],[MINI]], '[filen ame.xlsx]sheet1'!C5:D6, 2)", "VLOOKUP('[file name.xlsx]'!MINITABLE[[#THIS ROW],[MINI]],'[filen ame.xlsx]SHEET1'!C5:D6,2)"),
        # ("=VLOOKUP([filename.xlsx]sheet1!MINITABLE[[#THIS ROW],[MINI]], '[filename.xlsx]sheet1'!C5:D6, 2)", "=VLOOKUP(''!MINITABLE[[#THIS ROW],[MINI]],''!C5:D6,2)"),
        ("=VLOOKUP('[filename.xlsx]sheet1'!MINITABLE[[#THIS ROW],[MINI]], '[filename.xlsx]sheet1'!C5:D6, 2)", "VLOOKUP('[filename.xlsx]'!MINITABLE[[#THIS ROW],[MINI]],'[filename.xlsx]SHEET1'!C5:D6,2)"),
